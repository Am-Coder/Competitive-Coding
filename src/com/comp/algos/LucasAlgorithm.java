...
public class LucasAlgorithm {
	...
	//	Lucas theorem basically suggests that the value of nCr can
	//	be computed by multiplying results of niCri where ni and ri are 
	//	individual same-positioned digits in base p representations of n and r respectively..
