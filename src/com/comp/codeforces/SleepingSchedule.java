...
public class SleepingSchedule {
	...
	public static void main(String[] args) throws IOException {
		...
		p.println(solve(n, 0, l, r, a, 0, h));
		p.close();
		
	}
	
	static int[][] dp;
	public static int solve(int n, int t, int l, int r, int[] ar, int i, int h) {
		...
		return dp[i][t] = Math.max(solve(n, (t + ar[i]) % h, l, r, ar, i + 1, h),
		    solve(n, (t + ar[i] - 1) % h, l, r, ar, i + 1, h))
		        + val;
	}
