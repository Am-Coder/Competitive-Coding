	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < n; i++) {
			...
			for (int j = i + 1; j < n; j++) {
				...
				for (int l = 0; l < k; l++) {
					char ch1 = mat[i].charAt(l);
					char ch2 = mat[j].charAt(l);
					if (ch1 == ch2) {
						sb.append(ch1);
					} else {
						if ((ch1 == 'S' && ch2 == 'E') || (ch2 == 'S' && ch1 == 'E')) {
							sb.append('T');
						} else if ((ch1 == 'S' && ch2 == 'T') || (ch2 == 'S' && ch1 == 'T')) {
							sb.append('E');
						} else {
							sb.append('S');
						}
				...
				cou += hm.getOrDefault(sb.toString(), 0);
			}
			hm.put(mat[i], hm.getOrDefault(mat[i], 0) + 1);
		}
