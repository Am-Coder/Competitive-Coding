...
public class SolveMaze {
	...
	public static void dfs(char[][] mat, int x, int y, boolean[][] vis, int n, int m) {
		...
		dfs(mat, x + 1, y, vis, n, m);
		dfs(mat, x, y + 1, vis, n, m);
		dfs(mat, x - 1, y, vis, n, m);
		dfs(mat, x, y - 1, vis, n, m);
	}
